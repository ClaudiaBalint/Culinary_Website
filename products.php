                ...
                <div class="filterSection">
                    ...
                    <div class="filter" style="text-align: left;">
                        <h5>Alergeni</h5>
                            ...
                            <label class="mb-1"><input type="checkbox" name="allergen[]" value="lapte_de_vaca" <?php if(isset($_GET['allergen']) && in_array('lapte_de_vaca', $_GET['allergen'])) echo 'checked'; ?>> Lapte de vaca</label><br>
