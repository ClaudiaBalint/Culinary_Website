                           ...
                           <table class="table table-borderd table-striped">
                                <thead> 
                                    <div class="d-flex justify-content-between">
                                        <h5 class="float-start mt-2">Istoric comenzi</h5>
                                        <a href="myaccount.php" class="btn btn-warning mr-3 mb-3 float-right"><i class="fa fa-reply">Back</i></a>
                                      ...
                                      <tr>
                                        ...
                                        <th>Cost</th>
                                        <th>Data</th>
                                        <th>Vizualizeaza comanda
                                        </th>
                                    </tr>
                                <tbody>
                                <?php
                                    $favorites = getFavorites(); // Obțineți produsele favorite ale utilizatorului
                                    if (mysqli_num_rows($favorites) > 0) {
                                        foreach ($favorites as $favorite) {
                                            ...
                                            <tr>
                                                <td><?= $favorite['pid'] ?></td>
                                                <td><?= $favorite['name'] ?></td>
                                                <td> <img src="../uploads/<?= $favorite['image'] ?>" height="50px" width="50px" alt=""></td> 
                                                <td><?= $favorite['selling_price'] ?></td>
                                                <!-- Alte coloane pe care doriți să le afișați -->
                                            </tr>
                                            <?php
                                        }
                                    } else {
                                        ?>
                                        <tr>
                                            <td colspan="4">Nu a fost adăugat niciun produs la favorite.</td>
                                        </tr>
                                        <?php
                                    }
                                    ?>
