...
<meta charset="UFT-8">
                ...
                <li>
                    ...
                    <button class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="active" href="feedback.php">Recenzii</a></li>
                        </ul>
                    </div>
                </li> 
    ...
    <section id="page-header" class="about-header">
        <h2>Recenzii</h2>
        <p>Poti consulta opiniile clientilor in legatura cu site-ul nostru si poti lasa si tu o recenzie!</p>
    </section>
                           ...
                           <table class="table table-borderd table-striped">
                                ...
                                <tbody>
                                    ...
                                    if(mysqli_num_rows($feedback) > 0){
                                       ...
                                       ?>
                                            <tr>
                                               <td colspan="5">Nu sunt recenzii de afisat.</td>
                                            </tr>
