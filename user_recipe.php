...
<meta charset="UFT-8">
    ...
    <section id="header">
        ...
        <section id="page-header" class="about-header">
            <h2>Retetele adaugate de tine</h2>
        </section>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <h5><a href="product-view.php?recipe=<?= $citem['rid']; ?>" class="orange-text"><?= $citem['nume'] ?></a></h5>
                                                </td>
                                                <td>
                                                ...
                                                <td class="text-end">
                                                        <?php
                                                        if ($citem['status'] == 1) {
                                                            echo "<span class='badge bg-success'>Postată</span>";
                                                        } elseif ($citem['status'] == 0) {
                                                            echo "<span class='badge bg-warning text-dark'>În curs de verificare</span>";
                                                        } elseif ($citem['status'] == -1) {
                                                            echo "<span class='badge bg-danger'>Respinsă</span>";
                                                        } else {
                                                            echo "<span class='badge bg-secondary'>Necunoscut</span>";
                                                        }
                                                        ?>
                                                    </td>
